...
listFrame.pack(side = BOTTOM, fill=BOTH, expand=1)#fill내부 확장, expand외부까지 확장하라(빈공간 채우기)-yes(true)=1,no(false)=2가 존재

edt1= Entry(edtFrame, width=10);   edt1.pack(side=LEFT, padx=10, pady=10)#pad-여백을 만들어줌
